...
Story::Story(string N_Player_Name)
{
	...
	this->VEC_Dialogue =
	{
		...
		{ "??? > The ice is melting." },
		{ "??? > You're alive?" },
		{ (this->STR_Player_Name + " has awoken from deep slumber, after being captive in a block of ice for 41 years")},
		...
		{ ("??? > Here it comes " + this->STR_Player_Name + "!") },
		{ "END DIALOGUE" },
		{ "..." }, //17
		...
		{ this->STR_Player_Name + " > Well I'm on a mission to save the world, and you was stood in my way I guess..." },
		{ this->STR_Player_Name + " > Tell me what you know and I may spare you" },
		...
		{ this->STR_Player_Name + " > You dropped this weird part on the floor" },
		{ this->STR_Player_Name + " > Can you tell me more about it?" },
		...
		{ this->STR_Player_Name + " > Thank you so much, and I am sorry for what I have done to you" },
		...
		{ this->STR_Player_Name + " > Nuh uh, you tried to kill me! This seems important, and since that machine is 'behind you', I am keeping it!" },
		...
		{ this->STR_Player_Name + " > No can do, I need this to save the world" },
		...
		{ "A tall, lanky figure" },
		{ "It looks familiar" },
		{ this->STR_Player_Name + " > George Shaw!?" },
		{ "??? > *robotic noises*" },
		...
		{ "??? > " + this->STR_Player_Name + "..." },
		{ this->STR_Player_Name + " > George..." },
		...
		{ this->STR_Player_Name + " > You, in a way, revived my dead friend to make me fight him?? You're sick!" },
		{ "??? > *charges towards " + this->STR_Player_Name + "*" },
		{ "END DIALOGUE" },
		{ "..." },//118
		...
		{ this->STR_Player_Name + " > I-" },
		{ this->STR_Player_Name + " > don't know..." },
		{ this->STR_Player_Name + " > I was trapped, from the information I've gathered, for 41 years" },
		{ this->STR_Player_Name + " > I don't know how I'm here" },
		{ this->STR_Player_Name + " > But, I know, my mission..." },
		{ this->STR_Player_Name + " > ...is to save the world..." },
		...
		{ this->STR_Player_Name + " > You shouldn't exploit the planet of it's resources" },
		...
		{ this->STR_Player_Name + " > Sorry, but I'm keeping this little tool, and I am putting a stop to your scheme" },
		{ "The Mastermind > ARGH..." },
		...
		{ "The Mastermind > *sprints towards " + this->STR_Player_Name + "*" },
		{ this->STR_Player_Name + " > What the fu-" },
		{ "END DIALOGUE" },
		{ "..." },//161
		...
		{ this->STR_Player_Name + " > What is this!?" },
		{ this->STR_Player_Name + " > Why can't it just be so simple!" },
		{ "You have no choice but to stay on alert" },
		{ "Anything could happen" },
		{ "The black entity is protecting The Device from being re-activated" },
		{ "You have no choice but to fight" },
		{ this->STR_Player_Name + " > Please..." },
		{ this->STR_Player_Name + " > No more after this..." },
		{ "??? > *lunges towards " + this->STR_Player_Name + "*" },
		{ "END DIALOGUE" },
		{ "..." },//181
		{ this->STR_Player_Name + " > Is it over?" },
