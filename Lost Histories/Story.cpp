...
Story::Story()
{
	this->VEC_Dialogue =
	{
		...
		{ "??? > The ice is melting." },
		{ "??? > You're alive?" },
		{ (this->PLAYER_Reference.getName() + " has awoken from deep slumber, after being captive in a block of ice for 41 years")},
		...
		{ ("??? > Here it comes " + this->PLAYER_Reference.getName() + "!") },
		{ "END DIALOGUE" },
		{ "..." }, //17
		...
		{ (this->PLAYER_Reference.getName() + " > Artifact? What do you mean?") },
		{ "Russian Sergeant > I shall not go against my master" },
		{ "Russian Sergeant > You will never know from me..." },
		{ (this->PLAYER_Reference.getName() + " > And who's, HIM?") },
		...
		{ this->PLAYER_Reference.getName() + " > Well I'm on a mission to save the world, and you was stood in my way I guess..." },
		{ this->PLAYER_Reference.getName() + " > Tell me what you know and I may spare you" },
		...
		{ this->PLAYER_Reference.getName() + " > You dropped this weird part on the floor" },
		{ this->PLAYER_Reference.getName() + " > Can you tell me more about it?" },
		...
		{ this->PLAYER_Reference.getName() + " > Thank you so much, and I am sorry for what I have done to you" },
		...
		{ this->PLAYER_Reference.getName() + " > Nuh uh, you tried to kill me! This seems important, and since that machine is 'behind you', I am keeping it!" },
		...
		{ this->PLAYER_Reference.getName() + " > No can do, I need this to save the world" },
		...
		{ "A tall, lanky figure" },
		{ "It looks familiar" },
		{ this->PLAYER_Reference.getName() + " > George Shaw!?" },
		{ "??? > *robotic noises*" },
		...
		{ "??? > " + this->PLAYER_Reference.getName() + "..." },
		{ this->PLAYER_Reference.getName() + " > George..." },
		...
		{ this->PLAYER_Reference.getName() + " > You, in a way, revived my dead friend to make me fight him?? You're sick!" },
		{ "??? > *charges towards " + this->PLAYER_Reference.getName() + "*" },
		{ "END DIALOGUE" },
		{ "..." },//118
		...
		{ this->PLAYER_Reference.getName() + " > I-" },
		{ this->PLAYER_Reference.getName() + " > don't know..." },
		{ this->PLAYER_Reference.getName() + " > I was trapped, from the information I've gathered, for 41 years" },
		{ this->PLAYER_Reference.getName() + " > I don't know how I'm here" },
		{ this->PLAYER_Reference.getName() + " > But, I know, my mission..." },
		{ this->PLAYER_Reference.getName() + " > ...is to save the world..." },
		...
		{ this->PLAYER_Reference.getName() + " > You shouldn't exploit the planet of it's resources" },
		...
		{ this->PLAYER_Reference.getName() + " > Sorry, but I'm keeping this little tool, and I am putting a stop to your scheme" },
		{ "The Mastermind > ARGH..." },
		...
		{ "The Mastermind > *sprints towards " + this->PLAYER_Reference.getName() + "*" },
		{ this->PLAYER_Reference.getName() + " > What the fu-" },
		{ "END DIALOGUE" },
		{ "..." },//161
		...
		{ "7 hours of painful walking, and you finally reach The Device" },
		{ "All of your collected artefacts start to gravitate towards the machine" },
		{ "Something doesn't feel quite right" },
		{ "A black, liquid like substance shoots up from the ground blocking the machine" },
		{ "You jump back in shock" },
		{ this->PLAYER_Reference.getName() + " > What is this!?" },
		{ this->PLAYER_Reference.getName() + " > Why can't it just be so simple!" },
		{ "You have no choice but to stay on alert" },
		{ "Anything could happen" },
		{ "The black entity is protecting The Device from being re-activated" },
		{ "You have no choice but to fight" },
		{ this->PLAYER_Reference.getName() + " > Please..." },
		{ this->PLAYER_Reference.getName() + " > No more after this..." },
		{ "??? > *lunges towards " + this->PLAYER_Reference.getName() + "*" },
		{ "END DIALOGUE" },
		{ "..." },//181
		{ this->PLAYER_Reference.getName() + " > Is it over?" },
		{ "You have access to The Device, finally, after all of your efforts" },
		{ "You insert the Mysterious Machine Part into a socket" },
		{ "Placed the Frozen Crystal of Bitter Cold into the empty core capsule" },
		{ "The machine sparks to life!" },
		{ "After some time, an icey bolt gets shot into the atmosphere" },
		{ "You look around you as the planet begins to refreeze" },
		{ "You did it!" },
		{ "And now a word from the creator" },
		{ "Max > You beat the game! Congratulations!" },
		{ "Max > I playtested this too much, and believe it took me around 2.5 hours" },
		{ "Max > You getting to this point proves you have the will power..." },
		{ "Max > To sit here for a couple hours and beat a silly little text game" },
		{ "Max > Bonus points if you recognise where this game took like all of it's inspiration from" },
...
void Story::setPlayerReference(Player N_Player)
{
	this->PLAYER_Reference = N_Player;
}